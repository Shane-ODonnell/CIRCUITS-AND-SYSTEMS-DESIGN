...
int stickY1 = A1;   //pin that takes in Y value of joyStick
int clickPin1 = 2;  //stick that takes in stickClicks
...
void setup() {
  ...
  pinMode(clickPin1, INPUT_PULLUP);
  attachInterrupt(digitalPinToInterrupt(clickPin1), joystickClick, CHANGE);
